...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer) {
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor1->euclideanCluster(segmentCloud.first, 0.6, 8, 140);
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    ProcessPointClouds<pcl::PointXYZ>* pointCloud = new ProcessPointClouds<pcl::PointXYZ>();
  	...
  	std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> cloudClusters = pointCloud->euclideanCluster(segmentCloud.first, 1.2, 3, 30);
